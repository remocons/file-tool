import { readdir, rename, writeFile, stat, open, readFile } from 'fs/promises';
import { readdirSync, readFileSync, statSync, createWriteStream } from 'fs';
...
export { File, createObjectURL, getBlobFromURL, getFileSize, getFileSizeSync, getStat, getStatSync, loadFile, loadFileList, loadFileSync, pathJoin, readDirFiles, readDirFilesSync, readFileAsBuffer, readFileAsBufferSlice, readFileAsBufferSync, renameDirFilesRandomUUID, renameFile, renameRandomUUID, revokeObjectURL, saveBlob, wipeRandom };
